...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasherInterface, string $token = null): Response
    {
        ...
        try {
            ...
            $this->addFlash('reset_password_error',
                'A fost o problemă în a valida token-ul pentru resetarea parolei'
            );
    ...
    {
        $user = $this->getDoctrine()->getRepository(Pacient::class)->findOneBy([
            'email' => $emailFormData,
        ]);
        ...
        try {
            $resetToken = $this->resetPasswordHelper->generateResetToken($user);
             ...
             $this->addFlash('reset_password_error',
                 'A apărut o problemă in procesarea cererii de resetare parolă. '
             );
