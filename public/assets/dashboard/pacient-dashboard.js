...
function chartUpdateAjax(chart, url, chartContainer) {
    $.ajax({
        ...
        success: function (result)
        {
            ...
            // Update general data
            if(url === '/pacient/dashboard/distributie') {
...
$(document).ready(function() {
    ...
    chartUpdateAjax(distributionChart, '/pacient/dashboard/distributie');
    chartUpdateAjax(topChart, '/pacient/dashboard/top-medici');
});